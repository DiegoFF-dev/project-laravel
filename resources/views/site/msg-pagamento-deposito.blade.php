        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Seus dados foram enviados com sucesso para o responsável, não esqueça de levar o comprovante de deposito ao acampamento!
                    </p>
                    <p><b>Conta:</b> 17238-9</p>
                    <p><b>Agencia:</b> 3511</p>
                ...
                <div class="modal-footer"> 
                    <a href="{{route('site-index')}}" class="btn btn-success">Voltar</a>                                      
                    <a href="{{route('site-print-pdf')}}" class="btn btn-danger">Salvar PDF</a>
                </div>
            </div>
        </div>
    </div>
